        ...
        <br>
              <?php
               ...
               ?>
                ...
                <br>
                <h1>
                    <p class="text-center"><span style="background-color: rgb(209, 209, 209)">Before Tea Break 001</span>
                    </p>
                </h1>
                <br>
                <p class="card-text">
                    ・開催時刻：2019-12-22(日) 18:00:00<br>
                    ・開催時間：90分<br>
                    ・問題数：6問<br>
                    ・writer：otamay, Ultraviolett, sakaki_tohru, earlgray283<br>
                    ・ペナルティ：なし<br>
                    ・メニュー：Green-Ceylon-Darjeeling-Earlgray-Earlgray-Keemun<br>
                    ・注意事項<br>
                ...
                <br><br>
                <strong>Before Tea Break 001って何？</strong><br>
		CafeCoderのシステムがリニューアルしたときに、負荷テストなどをするために開催されるコンテストです。<br>
		喫茶店の開店前感覚のコンテストですので、Tea Breakよりも更に気軽に参加できるものとなっています。<br>
                問題セットは基本的に過去のものを流用するので、まだTea Breakに参加したことがない人や、復習をしたい人などにおすすめです。<br>
